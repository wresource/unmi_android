package io.unmi.app.ui.theme

import androidx.compose.ui.graphics.Color

// M3 Teal-based color scheme for a professional domain management app
// Generated from M3 color system with seed color #0D7377
...
val SafeGreen = Color(0xFF1B873B)
val SafeGreenLight = Color(0xFFD7F5DD)
val InfoBlue = Color(0xFF1565C0)
val InfoBlueLight = Color(0xFFDCEEFF)

// Grade colors
val GradeS = Color(0xFFD4AF37) // Gold
val GradeA = Color(0xFF1B873B) // Green
val GradeB = Color(0xFF1565C0) // Blue
val GradeC = Color(0xFFE67E22) // Orange
val GradeD = Color(0xFF757575) // Grey
